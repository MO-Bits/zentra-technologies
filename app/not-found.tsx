  ...
  return (
    <main id="main-content" className="not-found-page">
      <div className="section-width not-found-layout">
        ...
        <div><p className="eyebrow"><span /> Error 404</p><h1>This route does not exist.</h1><p>The page may have moved, or the address may be incomplete. Return to the Zentra homepage or explore our products.</p><div className="hero-actions"><Link className="button button--mint" href="/">Go to homepage <ArrowRight /></Link><a className="text-link" href="/products">Explore products <ArrowRight /></a></div></div>
      </div>
    </main>
  );
}
